...
{
	out << "List	Display each playlist with the number of songs in that playlist on the terminal." << endl;
	out << "View <playlist>	Display the songs in the <playlist> with tags on the terminal" << endl;
}